      ...
      <div class="horizontal-menu">
        ...
        <div class="nav-top flex-grow-1">
          <div class="container d-flex flex-row h-100 align-items-center">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="navbar-brand brand-logo" href="/"><img src="assets/img/logo.svg"></a>
              <!-- <a class="navbar-brand brand-logo-mini" href="/"><img src="assets/img/logo.svg"></a> -->
            </div>
        ...
        <div class="container">
          <ul class="nav page-navigation">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/petugastatib">
            ...
            <li class="nav-item">
              <a href="/poinsiswa" class="nav-link">
